        ...
        <div class="container">
            ...
            <section class="mainDiv">
                <div class="contentDiv">
                    <h2>Order Info</h2>
                    <form action="DistOrder" class="productForm" method="post">
                        <div class="partDiv">
                        ...
                        <div class="partDiv">
                            <div class="productItem">
                                <label for="quantity">Quantity </label> <p class="max_qty">Max Quantity <%=quantity%></p>
                                <input type="number" id="quantity" name="quantity" placeholder="Order Quantity" required min="1">
                            </div>
